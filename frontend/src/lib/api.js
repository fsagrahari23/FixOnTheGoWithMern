...
// Prefer explicit Vite env var, otherwise default to backend port 3000 in dev
const API_PREFIX = import.meta.env.VITE_API_BASE_URL || (import.meta.env.DEV ? 'http://localhost:3000' : '');
