        ...
        <Card className="border-0 shadow-lg">
            ...
            <CardContent className="p-6">
                <div className="text-center mb-6">
                    <p className="text-4xl font-bold text-primary mb-1">{premiumData.total}</p>
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                        ...
                        <span className="font-semibold">{premiumData.monthly}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                        <span className="text-sm text-muted-foreground">Yearly Plans</span>
                        <span className="font-semibold">{premiumData.yearly}</span>
                    </div>
