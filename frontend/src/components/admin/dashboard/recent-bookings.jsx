                        ...
                        <table className="w-full">
                            <thead className="border-b">
                                <tr className="text-left">
                                    ...
                                    <th className="pb-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">User</th>
                                    <th className="pb-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Mechanic</th>
                                    <th className="pb-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Problem</th>
                                        ...
                                        <td className="py-4">
                                            {booking.mechanic ? (
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-sm font-medium">{booking.mechanic.name}</span>
                                                </div>
                                            ) : (
